...
curl -v -H "Authorization: Basic `echo -n 'test_user2:p4ssw0rd2' | base64`" \
  -H "Content-Type: application/json" "http://localhost:${PORT}/${INDEX_NAME}/recommendation?id=d290f1ee-6c54-4b01-90e6-d701748f0851&id=d290f1ee-6c54-4b01-90e6-d701748f0852"
