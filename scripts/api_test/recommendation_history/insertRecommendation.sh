...
curl -v -H "Authorization: Basic `echo -n 'test_user:p4ssw0rd' | base64`" \
  -H "Content-Type: application/json" -X POST "http://localhost:${PORT}/${INDEX_NAME}/recommendation_history" -d '
{
          "id" : "a6494c3521120a2853cb7700d5790dfdd4e98821754f30ae838b6c7a067b6d7a54117af585004be8fcc4c7f74c5da31c0e6c56432329c19e4125242d8ef2ee34",
